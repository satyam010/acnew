...
from ..forms import TeacherSignUpForm,TeacherSignUpTwo,AttendanceForm,MarksCreateForm,HomeworkCreateForm,TeacherEditForm, TeacherEditFormTwo,RemarkCreateForm,RequestCreateForm
...
def RequestCreateView(request):
    ...
    return render(request, 'classroom/request_create.html', {
