...
# CREATION OF STUDENTS
	...
	for user in users:
		print("UserType : Student | Username : {} | password : {}".format(user.username,user.password))
...
# CREATION OF TEACHERS
	...
	for user in users:
		print("UserType : Teacher | Username : {} | password : {}".format(user.username,user.password))
...
# CREATION OF PARENTS
	...
	for user in users:
		print("UserType : Parent | Username : {} | password : {}".format(user.username,user.password))
